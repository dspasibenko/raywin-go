...
const rndStrCharset = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"

// RandomString returns a pseudo-random string by length ln.
func RandomString(ln int) string {
	return GetRandomString(ln, rndStrCharset)
}
...
// Maximum len of resulting string is maxSize
